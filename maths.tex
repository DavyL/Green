...
\addbibresource{maths}

\title{Approximation de la fonction de Green par m\'ethode autocoh\'erente}
...
\includegraphics[width = \textwidth]{photoem.jpg}
 \label{photoEm}
\caption{Sch\'ema de  la photoemission et de la photo\'mission inverse \cite{these}}
\end{figure}
...
\begin{figure}
\caption{Trac\'e de la solution physique et de la solution exacte}
\includegraphics[width = \textwidth]{CourbesPhys2.png}
\label{solphysa}
\end{figure}
...
Afin de r\'esoudre (\ref{YFinal}) nous allons utiliser la m\'ethode g\'en\'erale \cite{quartic}.
\begin{equation}
\label{YFinal}
